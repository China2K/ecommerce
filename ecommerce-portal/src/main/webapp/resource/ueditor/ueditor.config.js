...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		toolbars : [
				["bold", "italic", "underline", "insertunorderedlist",
						"insertorderedlist", "simpleupload", "insertimage",
						"link", "unlink", "removeformat", "fontfamily",
						"fontsize", "forecolor", "backcolor", "inserttable",
						"deletetable", "date", "time", "emotion",
						"justifyleft", "justifycenter", "justifyright",
						"justifyjustify", "undo", "redo", "fullscreen"], [], []]
	...
	function getUEBasePath(docUrl, confUrl) {
		/*
		 * var url=getBasePath(docUrl || self.document.URL ||
		 * self.location.href, confUrl || getConfigFilePath());
		 * if(url.indexOf("resource/ueditor")<0){ url=url+"resource/ueditor/"; }
		 */
