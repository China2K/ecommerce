...
(function() {
	...
	var isOnGitHub = window.location.hostname === 'blueimp.github.io', url = isOnGitHub
			? '//jquery-file-upload.appspot.com/'
			: 'server/php/';

	angular.module('demo', ['blueimp.fileupload']).config(['$httpProvider',
			'fileUploadProvider', function($httpProvider, fileUploadProvider) {
				...
				if (isOnGitHub) {
					...
					angular.extend(fileUploadProvider.defaults, {
								...
								// Opera,
								// which actually support image resizing, but
								// fail to
