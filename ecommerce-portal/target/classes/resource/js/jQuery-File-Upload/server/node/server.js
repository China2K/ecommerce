...
(function (port) {
    ...
    var path = require('path'),
        ...
        options = {
            ...
            acceptFileTypes: /.+/i,
            // Files not matched by this regular expression force a download
			// dialog,
            // to prevent executing any scripts in the context of the service
			// domain:
			 ...
			 * ssl: { key:
			 * fs.readFileSync('/Applications/XAMPP/etc/ssl.key/server.key'),
			 * cert:
			 * fs.readFileSync('/Applications/XAMPP/etc/ssl.crt/server.crt') },
			 */
            nodeStatic: {
